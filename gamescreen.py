...
background_image = pygame.transform.scale(
    pygame.image.load('gamebackground.png.png').convert(),
    (SCREEN_WIDTH, SCREEN_HEIGHT))

penguin_image = pygame.transform.scale(
    pygame.image.load('flappy.png').convert_alpha(), (300, 200))
penguin_rect = penguin_image.get_rect(center=(SCREEN_WIDTH // 2,
                                              SCREEN_HEIGHT // 2 - 30))

# Initialize font, render text, and set text position
text = pygame.font.Font(None, 36).render('Welcome to Flappy Bird ', True,
                                         pygame.Color('black'))
